...
function saveSettings(settings, cb) {
  ...
  $.ajax(settings)
    ...
    .catch(function(err) {
      NProgress.done();
      displayError(
        '<p>Sorry, there was an error saving your options. Please try <a class="alert-link" href="/connectGopher">logging in again</a>. If this continues to be a problem please <a class="alert-link" href="http://help.followupthen.com/contact">contact us</a>.</p> (' +
          err.responseText +
          ")"
      );
