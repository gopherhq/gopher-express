...
module.exports = {
  ...
  validateWebhook: function (req, res, next) {
    ...
    debug(req.headers['x-gopher-signature'], req.headers['x-gopher-timestamp'], req.rawBody);

    if (gopherClient.validateWebhook(req.headers['x-gopher-signature'], req.headers['x-gopher-timestamp'], req.rawBody, validateTimestamp)) {
