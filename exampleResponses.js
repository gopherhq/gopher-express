    ...
    response: [
      {
        body: [
          ...
          },
          {
            type: "html",
            text:
              '<table border=0" style="clear: both"><tr><td><h4>NOTES</h4><p>Whatever I emailed goes here, along with additional notes I added in ToDoist. https://console.aws.com</p></td></tr></table>'
          }
        ]
      }
    ]
